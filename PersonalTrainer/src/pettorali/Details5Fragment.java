...
public class Details5Fragment extends Fragment {
		...
		text4.setText("L’ esercizio Distensioni su panca piana al multipower è noto anche come Distensione alla Smith machine.");
		...
		text6.setText("Distensioni su panca piana al multipower è un esercizio Base.");
		...
		text10.setText("La posizione di partenza vede l'atleta sdraiato supino su una panca piana con glutei, parte alta della schiena,"
				...
				+ "equilibrato per garantire stabilità alla posizione.L'esecuzione "
