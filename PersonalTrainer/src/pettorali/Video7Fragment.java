...
public class Video7Fragment extends Fragment{
	...
	int totalSize = 0;
	TextView cur_val;
	String dwnload_file_path = "http://personaltrainer2014.altervista.org/video/petto/spinte_inclinata.mp4";
	float per=0;
	VideoView video;
	boolean flag=false;
	File file=null;
	...
	Thread t;
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			file = new File(SDCardRoot+"/PersonalTrainer/","spinte_inclinata.mp4");
	...
	void downloadFile() {
			...
			try {
				...
				getActivity().finish();
				Intent activity=new Intent(getActivity(),SubMenu7Activity.class);
