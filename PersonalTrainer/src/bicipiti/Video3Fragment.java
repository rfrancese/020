...
public class Video3Fragment extends Fragment{
	...
	int totalSize = 0;
	TextView cur_val;
	String dwnload_file_path = "http://personaltrainer2014.altervista.org/video/bicipiti/curl_con_bilanciere.mp4";
	float per=0;
	VideoView video;
	boolean flag=false;
	File file=null;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		file = new File(SDCardRoot+"/PersonalTrainer/","curl_con_bilanciere.mp4");
