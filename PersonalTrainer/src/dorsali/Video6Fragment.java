...
public class Video6Fragment extends Fragment{
	...
	int totalSize = 0;
	TextView cur_val;
	String dwnload_file_path = "http://personaltrainer2014.altervista.org/video/dorso/rematore_bilanciere.mp4";
	float per=0;
	VideoView video;
	boolean flag=false;
	File file=null;
	...
	Thread t;
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			file = new File(SDCardRoot+"/PersonalTrainer/","rematore_bilanciere.mp4");
	...
	void downloadFile() {
			...
			try {
				...
				getActivity().finish();
				Intent activity=new Intent(getActivity(),SubMenu6Activity.class);
