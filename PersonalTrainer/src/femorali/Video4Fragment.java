...
public class Video4Fragment extends Fragment{
	...
	int totalSize = 0;
	TextView cur_val;
	String dwnload_file_path = "http://personaltrainer2014.altervista.org/video/femorali/stacchi_gambe_tese.mp4";
	float per=0;
	VideoView video;
	boolean flag=false;
	File file=null;
	...
	Thread t;
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			file = new File(SDCardRoot+"/PersonalTrainer/","stacchi_gambe_tese.mp4");
