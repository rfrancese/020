...
public class Details3Fragment extends Fragment {
		...
		text4.setText("L'esercizio Mezzi stacchi alla rumena è noto anche come Romenian half deadlift, Romenian deadlift, Stacchi alla rumena, Stacco alla rumena.");
		...
		text6.setText("Mezzi stacchi alla rumena è un esercizio Multiarticolare/accessorio.");
		...
		text10.setText("La posizione di partenza vede l'atleta in posizione eretta con le scapole addotte e le ginocchia leggermente"
				...
				+ "angolo. La fase di discesa termina nel punto oltre al quale non è più possibile mantenere la schiena nella sua "
