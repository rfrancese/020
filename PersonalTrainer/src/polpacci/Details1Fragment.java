...
public class Details1Fragment extends Fragment {
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {
		...
		text2.setText("Calf Machine seduto");
		...
		text10.setText("Posizionati alla Calf Machine, abbassare i talloni sino a che l'articolazione lo consente, effettuare "
				+ "la fase di ritorno sollevando il più possibile il tallone e facendo forza sull'avampiede. Mantenere la "
				+ "posizione raggiunta per un secondo, e ripartire.\n");
	}
}
